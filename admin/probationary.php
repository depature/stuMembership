...
<?php
            require("../connect.php"); 
            $sql = "SELECT * FROM `stuinfo` where status='预备党员'";
            ...
            while($row= $result->fetch_assoc()) {
                ...
                <td>".$row['status']."</td>
                <td><a class='btn btn-info' href='../zhuanzheng/".$row['uid'].".doc'>下载</a></td>
                <td><a class='btn btn-info' href='probationary-agree.php?uid=".$row['uid']."'>同意</a></td>
            </tr>");
            }
        ?>
        </tbody>
